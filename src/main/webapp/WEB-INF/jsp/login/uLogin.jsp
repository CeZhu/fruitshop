...
<body>
<div class="width100 hidden_yh" style="height: 573px;background: url('${ctx}/resources/user/images/bj.jpg') no-repeat center">
            ...
            <form action="${ctx}/login/utoLogin" method="post">
                ...
                <div class="center_yh hidden_yh" style="width: 336px;">
                    ...
                    <div class="width100 box-sizing hidden_yh" style="height: 44px;border:1px solid #c9c9c9;margin-bottom: 34px;">
                        <img src="${ctx}/resources/user/images/rw.jpg" alt="" class="left_yh" width="42" height="42">
                    ...
                    <div class="width100 box-sizing hidden_yh" style="height: 44px;border:1px solid #c9c9c9;margin-bottom: 34px;">
                        <img src="${ctx}/resources/user/images/pass.jpg" alt="" class="left_yh" width="42" height="42">
